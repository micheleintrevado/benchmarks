inputs = %{
  ...
  "2_000_000" => {(for n <- 1..2_000_000, into: %{}, do: {Integer.to_string(n), n}), (for n <- 1..2_000_000, into: %{}, do: {Integer.to_string(n), n}) |> Aja.OrdMap.new(), :rand.uniform(2_000_000) |> Integer.to_string()}
...
Benchee.run(
 ...
 save: [path: Path.join(__DIR__, "map_delete_profiler.benchee")],
 formatters: [

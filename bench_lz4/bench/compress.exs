...
Benchee.run(
  ...
  title: "compress lz4 0.1.3",
  parallel: 4,
  time: 10,
  memory_time: 5,
  measure_function_call_overhead: true,
  save: [path: Path.join(__DIR__, "compress_lz4_0.1.3.benchee")],
  formatters: [
    Benchee.Formatters.Console,
    {Benchee.Formatters.HTML, file: Path.join(__DIR__, "compress/compress_lz4_0.1.3.html")}
  ]
)
